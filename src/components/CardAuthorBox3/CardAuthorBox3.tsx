...
const CardAuthorBox3: FC<CardAuthorBox3Props> = ({
  ...
  const editClickHandler = (id: any) => {
    history.push("/edit-profile?id=" + id);
  };

  const historicalClickHandler = (id: any) => {
    history.push("/historical?id=" + id);
  };
  ...
  return (
    ...
    >
      ...
      <div className="-mt-6">
        ...
        <div className="mt-2.5 flex items-start justify-between mb-3">
          <div>
          ...
          <div className="flex items-center justify-center">
            ...
            <ButtonPrimary
              ...
              sizeClass="px-4 py-1.5"
              fontSize="text-sm font-medium"
              onClick={() => historicalClickHandler(user?._id)}
            >
              Historical
            </ButtonPrimary>
          </div>
