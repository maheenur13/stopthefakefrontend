...
const CardCategory5: FC<CardCategory5Props> = ({
  ...
  return (
    <a
      ...
      target="_blank"
      rel="noreferrer"
      className={`nc-CardCategory5 flex flex-col ${className} montion-link`}
    ...
    >
      ...
      <div className="mt-4 flex items-center">
        ...
        <div className="ml-3">
          <h2
            className={`text-base sm:text-lg text-neutral-900 dark:text-neutral-100 font-medium truncate montion-title`}
          >
            <span>{name}</span>{" "}
            <span>
          ...
          <span
            className={`block mt-1 text-sm text-neutral-6000 dark:text-neutral-400 montion-desc`}
          >
            {desc}
